...
$sgl_join="SELECT * FROM user LEFT JOIN passport ON user.id = passport.user_id LIMIT 5,5";
...
echo '<a href="/first.php"><strong><font size="3" color="#006400">' .$button1. '</strong></font size="6"color="#006400"></a>'.'<br>'.'<br>';
